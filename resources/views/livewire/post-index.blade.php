                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right text-sm">
                                    <div class="flex space-x-2">
                                        <x-jet-button wire:click="showingEditModal({{ $post->id }})">Edit</x-jet-button>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            @if ($oldImage)
                                Old Image:
                                <img src="{{ Storage::url($oldImage) }}" class="w-16 h-18 rounded">
                            @endif
                            @if ($newImage)
                                Photo Preview:
                                <img src="{{ $newImage->temporaryUrl() }}" class="w-18 h-18 rounded">
                            @endif
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            @error('body') <span class="error text-red-400">{{ $message }}</span> @enderror
                        </div>
                    </form>
                </div>
            </x-slot>
